// body - text field 
// colors - stores stringified JSON object of color settings for the note
// position - stored stringified JSON object of X and Y coordinates


/* JSON has to be stringify because from the DB, it will be stored as string */
